...
export default function ReadUser() {
  ...
  async function deleteUser() {
    try {
      ...
      const res = await fetch(`${baseURL}/api/admin/users/${username}`, { method: 'delete' });
  ...
  return (
    <>
      ...
      <Row gap="10px" justifyContent="left">
        ...
        <PrimaryButton onClick={() => setIsEditing((state) => !state)}>Edit User</PrimaryButton>
        {isEditing && <SuccessButton onClick={handleSubmit}>Submit</SuccessButton>}
      </Row>
    </>
  );
}
